...
export default function CommunityBlogPostsBlogTemplate() {
  return (
    <>
      <header>
        <Navbar fluid className="max-w-screen-xl dark:bg-gray-800">
          <NavbarBrand
            href="#"
          ...
          <div className="flex md:order-2">
            <Button className="[&>span]:py-2.5">Get started</Button>&nbsp;&nbsp;
            <NavbarToggle />
          </div>
          <NavbarCollapse className="[&>ul]:md:text-base">
      ...
      <main className="bg-white pb-16 pt-8 antialiased dark:bg-gray-900 lg:pb-24 lg:pt-16">
        <div className="mx-auto flex max-w-screen-xl justify-between px-4 xl:px-0 ">
          <div className="mb-6 hidden lg:w-52 xl:block">
            <div className="sticky top-6">
              ...
              <aside aria-labelledby="categories-label">
                ...
                <nav className="mb-6 rounded-lg border border-gray-200 p-6 font-medium text-gray-500 dark:border-gray-700 dark:text-gray-400">
                  <ul className="mb-6 space-y-4">
                    ...
                    <li>
                      <a
                        href="#"
                        className="dark:hover-text-primary-500 flex items-center hover:text-primary-600"
                      >
                        <svg
                          className="mr-2 h-4 w-4"
                          aria-hidden="true"
              ...
              <aside>
                <div className="mb-3 flex h-32 w-full items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800">
                  <svg
                    aria-hidden="true"
          ...
          <article className="format format-sm format-blue mx-auto w-full max-w-2xl dark:format-invert sm:format-base lg:format-lg">
            <header className="not-format mb-4 lg:mb-6">
              ...
              <div className="text-base">
                ...
                &nbsp;on <time title="February 8th, 2022">Feb. 8, 2022</time>
              </div>
            </header>
            <div className="flex items-center justify-between">
              <aside aria-label="Share social media">
                <a
                  href="#"
                  className="mr-2 inline-flex items-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-900 no-underline hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  <svg
                ...
                <a
                  href="#"
                  className="inline-flex items-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-900 no-underline hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  <svg
                    className="mr-2 h-3 w-3"
                    aria-hidden="true"
            ...
            <section className="not-format">
              ...
              <div className="flex">
                ...
                <form className="mb-6 w-full">
                  ...
                  <Button
                    type="submit"
                    className="[&>span]:py-2.5 [&>span]:text-xs"
                  >
                    Post comment
                  </Button>
                </form>
          ...
          >
            <div className="sticky top-6">
              ...
              <div className="mb-6 rounded-lg border border-gray-200 p-6 text-gray-500 dark:border-gray-700 dark:text-gray-400">
                ...
                <dl className="mb-5">
                  <dt className="mb-2 text-sm font-bold uppercase text-gray-900 dark:text-white">
                    Location
                  </dt>
                ...
                <Button className="w-full [&>span]:py-2.5">Follow</Button>
              </div>
              <div className="mb-6 rounded-lg border border-gray-200 p-6 font-medium text-gray-500 dark:border-gray-700 dark:text-gray-400">
                <form className="mb-6">
                ...
                <h4 className="mb-6 font-bold uppercase text-gray-900 dark:text-white">
                  Recommended topics
                </h4>
                <div className="flex flex-wrap gap-3 [&>span]:text-sm [&>span]:font-medium">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 font-medium text-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
                <h4 className="mb-6 font-bold uppercase text-gray-900 dark:text-white">
                  Who to follow
                </h4>
      ...
      <section className="bg-white antialiased dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl p-4 py-12 text-center lg:py-24">
          ...
          <Button className="mx-auto [&>span]:py-2.5">Create an account</Button>
        </div>
      </section>

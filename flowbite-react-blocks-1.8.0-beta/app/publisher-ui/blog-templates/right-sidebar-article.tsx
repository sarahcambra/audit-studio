          ...
          <article className="format format-sm format-blue mx-auto w-full dark:format-invert sm:format-base lg:format-lg">
            <header className="not-format mb-4 lg:mb-6">
              <Breadcrumb>
                ...
                <BreadcrumbItem href="#">Tech</BreadcrumbItem>
                <BreadcrumbItem>Prototyping from A to Z</BreadcrumbItem>
              </Breadcrumb>
            ...
            >
              <TableHead className="text-base [&_th]:normal-case">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>April 21, 2021</TableCell>
                  <TableCell>
                    <strong>$2,300</strong>
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>May 31, 2021</TableCell>
                  <TableCell>
                    <strong>$300</strong>
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>June 3, 2021</TableCell>
                  <TableCell>
                    <strong>$2,500</strong>
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>June 23, 2021</TableCell>
                  <TableCell>
                    <strong>$3,543</strong>
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>July 6, 2021</TableCell>
                  <TableCell>
                    <strong>$99</strong>
                  </TableCell>
                </TableRow>
      ...
      <Footer className="rounded-none bg-gray-50 antialiased dark:bg-gray-800">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6">
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
            ...
            <div>
              <FooterTitle title="Company" className="text-gray-900" />
              <FooterLinkGroup
                col
            ...
            <div>
              <FooterTitle title="Help Center" className="text-gray-900" />
              <FooterLinkGroup
                col
                className="text-base text-gray-500 dark:text-gray-400"
              >
            ...
            <div>
              <FooterTitle title="Legal" className="text-gray-900" />
              <FooterLinkGroup
                col
                className="text-base text-gray-500 dark:text-gray-400"
              >
            ...
            <div>
              <FooterTitle title="Download" className="text-gray-900" />
              <FooterLinkGroup
                col
                className="text-base text-gray-500 dark:text-gray-400"
              >

import { Button, Modal, ModalBody, Table, TableBody, TableCell, TableHead, TableHeadCell, TableRow, ToggleSwitch } from "flowbite-react";
            ...
            <div className="pt-4">
              ...
              >
                <Table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                  <TableHead className="bg-gray-100 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                    <TableHeadCell className="px-6 py-3">Name</TableHeadCell>
                  ...
                  <TableBody>
                    <TableRow className="bg-gray-100 dark:bg-gray-800">
                      ...
                      <TableCell className="px-6 py-4">1 Year</TableCell>
                      <TableCell className="px-6 py-4">
                    ...
                    <TableRow className="bg-gray-100 dark:bg-gray-800">
                      ...
                      <TableCell className="px-6 py-4">Hubspot Inc</TableCell>
                      <TableCell className="px-6 py-4">Session</TableCell>
                      <TableCell className="px-6 py-4">
                        Web page delivery
                      </TableCell>
                    </TableRow>
                    <TableRow className="bg-gray-100 dark:bg-gray-800">
                      ...
                      <TableCell className="px-6 py-4">Linkedin</TableCell>
                      <TableCell className="px-6 py-4">1 Day</TableCell>
                      <TableCell className="px-6 py-4">
                        Marketing tracking
                      </TableCell>
                    </TableRow>
            ...
            >
              <Table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                <TableHead className="bg-gray-100 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                  ...
                  <TableHeadCell className="px-6 py-3">Purpose</TableHeadCell>
                </TableHead>
                <TableBody>
                  <TableRow className="bg-gray-100 dark:bg-gray-800">
                    <TableCell className="whitespace-nowrap px-6 py-4 text-gray-500 dark:text-gray-400">

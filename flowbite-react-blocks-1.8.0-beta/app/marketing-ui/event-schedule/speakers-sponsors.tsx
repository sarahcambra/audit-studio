import { Avatar, Badge, Timeline, TimelineBody, TimelineContent, TimelineItem, TimelineTime, TimelineTitle } from "flowbite-react";
              ...
              <TimelineItem className="mb-0">
                <TimelineContent>
                  <div className="mb-0 md:flex">
                    <TimelineTime className="flex-[0_0_7rem] py-1 pr-3 text-sm text-gray-500 dark:text-gray-400">
                      07:00 - 08:00
                    </TimelineTime>
                  ...
                  <div className="mb-0 md:flex">
                    ...
                    <div className="border-gray-300 pb-8 dark:border-gray-600 md:border-l md:pl-3">
                      <div className="rounded-lg bg-gray-100 p-3 dark:bg-gray-800">
                        <TimelineTitle>Coffee &amp; networking</TimelineTitle>
                        <TimelineBody className="space-y-3">

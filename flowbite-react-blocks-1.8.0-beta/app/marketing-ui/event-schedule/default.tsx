import { Timeline, TimelineContent, TimelineItem, TimelineTime, TimelineTitle } from "flowbite-react";
    ...
    <section className="bg-white antialiased dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 lg:py-24">
        ...
        <div className="mx-auto mt-8 flow-root max-w-3xl sm:mt-12 lg:mt-16">
          ...
          >
            <TimelineItem className="mb-4 ml-0 border-b border-gray-200 pb-4 dark:border-gray-700">
              <TimelineContent className="items-center gap-5 md:flex">
                <TimelineTime className="mb-0 text-lg text-gray-500">
                  08:00 - 09:00
                </TimelineTime>
                <TimelineTitle>Opening remarks</TimelineTitle>
              </TimelineContent>
            </TimelineItem>
            <TimelineItem className="mb-4 ml-0 border-b border-gray-200 pb-4 dark:border-gray-700">
              <TimelineContent className="items-center gap-5 md:flex">
            ...
            <TimelineItem className="mb-4 ml-0 border-b border-gray-200 pb-4 dark:border-gray-700">
              <TimelineContent className="items-center gap-5 md:flex">
                ...
                <TimelineTitle>Coffee Break</TimelineTitle>
              </TimelineContent>
            </TimelineItem>
            <TimelineItem className="mb-4 ml-0 border-b border-gray-200 pb-4 dark:border-gray-700">
              <TimelineContent className="items-center gap-5 md:flex">
            ...
            <TimelineItem className="ml-0">
              <TimelineContent className="items-center gap-5 md:flex">
                <TimelineTime className="mb-0 text-lg text-gray-500">
                  17:00 - 14:00
                </TimelineTime>
                <TimelineTitle>Drinks &amp; networking</TimelineTitle>
              </TimelineContent>
            </TimelineItem>
          </Timeline>
        </div>

import { Avatar, AvatarGroup, Button, Checkbox, Label, TextInput } from "flowbite-react";

export function DescriptionAccountRecovery() {
  return (
          ...
          <div className="max-w-md xl:max-w-xl">
            ...
            <div className="flex items-center divide-x divide-blue-500">
              <div className="flex -space-x-4 pr-3 sm:pr-5">
                <AvatarGroup className="[&_img]:ring-white dark:[&_img]:ring-white">
                  <Avatar
                    alt="bonnie avatar"

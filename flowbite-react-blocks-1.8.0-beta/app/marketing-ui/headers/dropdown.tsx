import { Button, Dropdown, DropdownItem, Navbar, NavbarBrand, NavbarCollapse, NavbarLink, NavbarToggle, theme } from "flowbite-react";
    ...
    <header>
      <Navbar fluid>
        ...
        >
          ...
          <NavbarLink href="#" className="flex h-full items-center">
            Features
          </NavbarLink>
          <NavbarLink href="#" className="flex h-full items-center">
            Marketplace
          </NavbarLink>
          <NavbarLink className="-mx-4 [&_span]:items-center">
            <Dropdown
              color="none"
              label="Company"
              theme={{

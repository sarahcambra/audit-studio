    ...
    <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div className="mx-auto max-w-xl px-4 sm:px-0">
        ...
        <form action="#" className="mx-auto max-w-xl space-y-6">
          ...
          >
            <TabItem active title="Credit card">
            ...
            <TabItem active title="Monthly fees">
              ...
              <div className="relative my-5 overflow-x-auto">
                <Table className="w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
                  <TableHead className="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                    <TableHeadCell
                      scope="col"
                    ...
                    <TableHeadCell scope="col" className="rounded-tr-md">
                      <span className="sr-only">Actions</span>
                    </TableHeadCell>
                  </TableHead>
                  <TableBody>
                    <TableRow className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"

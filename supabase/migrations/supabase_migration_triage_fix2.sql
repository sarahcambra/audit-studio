-- ============================================================
-- Fix triage_items: unique constraint + decision values + backfill
-- Run in Supabase SQL Editor.
-- ============================================================

-- 1. Add the unique constraint needed by upsert onConflict
...
--    decision = NULL means untriaged (safe — CHECK constraints skip NULLs)

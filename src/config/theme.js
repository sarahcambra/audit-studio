...
export const customTheme = createTheme({
  ...
  card: {
    ...
    // Semantic color variants used by StatCard (ScanResults + AuditsPage)
    color: {
      neutral:     'bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700',
      primary:     'bg-primary-50 border-primary-200 dark:bg-primary-900/20 dark:border-primary-800/50',
      critical:    'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800/50',
      danger:      'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800/50',
      warning:     'bg-amber-50 border-amber-200 dark:bg-amber-900/20 dark:border-amber-800/50',
      success:     'bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-800/50',
      info:        'bg-blue-50 border-blue-200 dark:bg-blue-900/20 dark:border-blue-800/50',
      alternative: 'bg-gray-50 border-gray-200 dark:bg-gray-700/40 dark:border-gray-600',
    },
  },

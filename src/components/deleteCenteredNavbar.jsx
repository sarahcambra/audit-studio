...
export function DefaultDashboardNavbar({ onNewAudit }) {
  const { theme: appearanceMode, toggleTheme } = useTheme();
  ...
  return (
    <header>
        ...
        <div className="flex w-full flex-wrap items-center justify-between">
          ...
          <div className="flex items-center gap-x-2 lg:order-2">
            ...
            >
              {appearanceMode === "dark" ? (
                <svg
                  ...
                  viewBox="0 0 20 20"
                >
                  <path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.08-13.658l-.707.707A1 1 0 0018 10h-1a1 1 0 100 2 1 1 0 001-.05l-.707-.707 1 1a1 1 0 00-1.414-1.414l-.707-.707zm-17.716 17.716l-.707-.707A1 1 0 0019 17h1a1 1 0 100-2h-1v-.05zm0-17.716a1 1 0 011.415 1.416l-.706.706A1 1 0 012.928 6.343l-.707-.707zM17.657 2.928a1 1 0 010 1.414l-.706.706A1 1 0 0115.557 5.657l-.707-.706a1 1 0 011.807-.023zM3.05 17.05a1 1 0 010-1.414l-.706-.706A1 1 0 002.928 17.708l-.707-.707zm12.728 0l.707-.707a1 1 0 00-1.414-1.414l-.707.707 1 1a1 1 0 001.415 0zm-17.086-13.728a1 1 0 010 1.414l-.706.706A1 1 0 01.928 10H0a1 1 0 100 2 1 1 0 001-.05l-.707-.707z" />
                </svg>
              ) : (
                <svg
                  className="h-5 w-5"
            ...
            <Dropdown
              ...
              theme={{
                arrowIcon: "hidden",
                content: twMerge(flowbiteTheme.dropdown.content, "py-0"),
                floating: {
                  base: twMerge(flowbiteTheme.dropdown.floating.base, "w-96"),
                },
                inlineWrapper: twMerge(
                  flowbiteTheme.dropdown.inlineWrapper,
            ...
            <Dropdown
              ...
              theme={{
                arrowIcon: "hidden",
                floating: {
                  base: twMerge(flowbiteTheme.dropdown.floating.base, "w-60"),
                },
                inlineWrapper: twMerge(
                  flowbiteTheme.dropdown.inlineWrapper,
      ...
      <Modal show={isDrawerOpen} onClose={() => setIsDrawerOpen(false)} size="2xl" popup>
        <Modal.Body className="p-0">
          <NewAuditWizard onClose={() => setIsDrawerOpen(false)} />
        </Modal.Body>
      </Modal>
    </header>
  );
...
// Keeps App.jsx default import working; after paste sync this name with `export function …` above.
export default DefaultDashboardNavbar;

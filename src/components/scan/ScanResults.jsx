...
function StatCard({ icon: Icon, label, value, colorVariant, active, onClick }) {
  const color = customTheme.card.color[colorVariant] ?? customTheme.card.color.neutral
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    <Card>
      ...
      {results.screenshot && (
        <div className="mb-4">
          ...
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Red outlines indicate violation locations</p>
        </div>
      )}
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {/* Impact */}
            <Badge color="gray" className={IMPACT_COLORS[group.impact] || IMPACT_COLORS.minor}>
              {group.impact}
            </Badge>
            {/* Issue type */}
            <Badge color="gray" className={ISSUE_TYPE_COLORS[group.issueType] || ISSUE_TYPE_COLORS['needs review']}>
          ...
          <div className="flex flex-wrap items-center gap-1.5 mt-2">
            ...
            {group.fixDifficulty && (
              <>
                <span className="text-xs text-gray-400">·</span>
                <Badge color="gray" className={FIX_DIFFICULTY_COLORS[group.fixDifficulty] || FIX_DIFFICULTY_COLORS.Medium}>

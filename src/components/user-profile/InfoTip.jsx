...
export default function InfoTip({ label, content }) {
  return (
    <Tooltip content={content} placement="top" style="dark">
      <button type="button" className="ms-1 text-gray-400 hover:text-gray-900 dark:hover:text-white" aria-label={label}>

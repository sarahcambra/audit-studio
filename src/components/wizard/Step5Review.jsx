import { Badge, Card, Alert } from 'flowbite-react'
    ...
    <section className="space-y-4 max-w-3xl">
      ...
      <Card theme={customTheme.card}>
        <div className="mb-4 flex items-center gap-2">
          ...
          <Badge color="primary" size="sm" theme={customTheme.badge}>
      ...
      <Card theme={customTheme.card}>
        <div className="mb-4 flex items-center gap-2">
          ...
          <Badge color="warning" size="sm" theme={customTheme.badge}>
          ...
          {form.scopeItems.map((item, index) => (
            <div key={index} className="rounded-xl border border-gray-100 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-700/50">
              <div className="flex items-start justify-between gap-3">
                ...
                <Badge color={getTypeBadgeColor(item.type)} size="sm" theme={customTheme.badge}>
                  {item.type}
                </Badge>
              </div>
            </div>

    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <TextInput
          ...
          aria-invalid={showValidationErrors && !form.auditName?.trim() ? "true" : undefined}
          aria-describedby={showValidationErrors && !form.auditName?.trim() ? "auditName-error" : undefined}
          sizing="md"
          theme={customTheme.textInput}
          required
        />
        {showValidationErrors && !form.auditName?.trim() && (
          <p id="auditName-error" role="alert" className="text-xs text-red-600 dark:text-red-400 mt-1">

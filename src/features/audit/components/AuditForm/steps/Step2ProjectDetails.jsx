    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <TextInput
          ...
          aria-invalid={isProjectNameInvalid ? "true" : undefined}
          aria-describedby={isProjectNameInvalid ? "projectName-error" : undefined}
          theme={customTheme.textInput}
          required
        />
        {isProjectNameInvalid && (
          <p id="projectName-error" role="alert" className="text-xs text-red-600 dark:text-red-400 mt-1">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <TextInput
            ...
            aria-invalid={isUrlInvalid ? "true" : undefined}
            aria-describedby={isUrlInvalid ? "websiteUrl-error" : undefined}
            theme={customTheme.textInput}
          />
          {isUrlInvalid && (
            <p id="websiteUrl-error" role="alert" className="text-xs text-red-600 dark:text-red-400 mt-1">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <TextInput
            ...
            aria-invalid={isAuditorNameInvalid ? "true" : undefined}
            aria-describedby={isAuditorNameInvalid ? "auditorName-error" : undefined}
            theme={customTheme.textInput}
          />
          {isAuditorNameInvalid && (
            <p id="auditorName-error" role="alert" className="text-xs text-red-600 dark:text-red-400 mt-1">
